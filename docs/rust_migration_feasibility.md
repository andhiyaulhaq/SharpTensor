...
- **Rayon**: We can use the `rayon` crate for "Data Parallelism." This would allow us to encode multiple images from your neighborhood _simultaneously_ across all CPU cores, rather than sequentially.
