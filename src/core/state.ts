...
export class AppState {
   ...
   */
  subscribe(callback: (data: AppStateData, oldState: AppStateData) => void): () => void {
  ...
  set(partialData: Partial<AppStateData>): void {
    ...
    this.data = { ...this.data, ...partialData } as AppStateData;
    this.notify(oldState);
  }

  private notify(oldState: AppStateData): void {
  ...
  get currentImage() {
    ...
    return this.data.images[this.data.currentImageIndex] || null;
  }
}
